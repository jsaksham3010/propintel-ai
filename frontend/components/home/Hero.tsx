    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-64px)] max-w-7xl flex-col items-center justify-center px-6 text-center">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <button className="flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-7 py-3 font-medium text-white transition hover:bg-blue-700">
            Get Started
            <ArrowRight size={18} />
          </button>

          <button className="rounded-xl border border-border px-7 py-3 font-medium transition hover:bg-accent">
            Learn More
          </button>
        </div>
